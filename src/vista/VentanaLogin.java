...
public class VentanaLogin extends JFrame {
    ...
    private void intentarLogin() {
        ...
        if (ok) {
            ...
            // Inyectamos el controlador a la siguiente ventana
            new VentanaMenu(sessionController).setVisible(true);
            dispose(); // Cerramos login para liberar recursos
        } else {
    ...
    private void abrirRegistro() {
        // Asegúrate de tener creada la VentanaRegistro en el paquete vista
